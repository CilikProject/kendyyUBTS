...
async def source(e):
    ...
    await edit_or_reply(
        e,
        "Click [here](https://github.com/Mhdkendyy/kendyyUBT) to open this bot source code\
        \nClick [here](https://github.com/Mhdkendyy/kendyynekopack) to open supported link for heroku",
    )
