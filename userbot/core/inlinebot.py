...
def get_thumb(name):
    url = f"https://github.com/Mhdkendyy/kendyyUB-Resources/blob/master/Resources/Inline/{name}?raw=true"
...
async def article_builder(event, method):
    ...
    title = "Cat Userbot"
    description = "Button menu for kendyyUBT"
    if method == "help":
        help_info = main_menu()
        title = "Help Menu"
        description = "Help menu for kendyyUBT."
    ...
    if method == "ls":
        ...
        media = "https://github.com/Mhdkendyy/kendyyUB-Resources/raw/master/Resources/Inline/filemanager.jpg"
    elif method == "deploy":
        media = "https://github.com/Mhdkendyy/kendyyUB-Resources/raw/master/Resources/Inline/catlogo.png"
        title = "𝘾𝙖𝙩𝙐𝙨𝙚𝙧𝙗𝙤𝙩"
        description = "Deploy yourself."
        query = "𝗗𝗲𝗽𝗹𝗼𝘆 𝘆𝗼𝘂𝗿 𝗼𝘄𝗻 𝗖𝗮𝘁𝗨𝘀𝗲𝗿𝗯𝗼𝘁."
        buttons = [
            (
                Button.url("Source code", "https://github.com/Mhdkendyy/kendyyUBT"),
                Button.url("Deploy", "https://github.com/Mhdkendyy/kendyynekopack"),
            )
        ]
        ...
        buttons = [
            (
                ...
                Button.url("Repo", "https://github.com/Mhdkendyy/kendyyUBT"),
            )
        ]
        try:
        ...
        description = "Alive menu for kendyyUBT."
        ...
        try:
            ...
            media = "https://github.com/Mhdkendyy/kendyyUB-Resources/raw/master/Resources/Inline/spotify_off.png"
            if (
